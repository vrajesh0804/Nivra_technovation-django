# Django Advanced Portfolio Site

A portfolio project built with Django and modern frontend tooling to explore **advanced** view logic, template structuring, and responsive UI using Bootstrap and custom CSS.
